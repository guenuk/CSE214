...
public class SnakeWorld {
    ...
    private static class Apple {
        ...
        public int create() {
            ...
            while(true) {
            	int ran1 = rand.nextInt(WIDTH);
            	int ran2 = rand.nextInt(HEIGHT);
            	this.pos = new Pos(ran1,ran2);
            	if(!hit(snake.getPos(),this.pos)&& !hit(wall.getPos(),this.pos))
            		break;
            }
            return createCount++;
        }
    ...
    private static class Snake {
        ...
        public Pos nextHeadPos() {
        	...
        	Pos ret = new Pos(pos.first().x+DX[dir], pos.first().y+DY[dir]);
        	return ret;
        }
        public void move() {
    ...
    public boolean step() {
        ...
        if(hit(getSnakePos(), getApplePos())) {
